<template>
	<view class="" >
		<view class="proRowList pdlr4 whiteBj">
			<view class="item pdtb15 flexRowBetween">
				<view class="ll">
				...
				<view class="rr">
					...
					<view class="Bmny">
						<view class="price fs14">56.00/元</view>
					</view>
		...
		<view class="myRowBetween fs13 whiteBj">
			...
			<view class="item flexRowBetween">
				...
				<view class="rr">
					<view class="fs13">2019年12月10日</view>
